...
export type ApiKeyInsert =
  ...
  & Partial<
    Omit<ApiKeyRow, "id" | "org_id" | "name" | "prefix" | "key_hash" | "role">
  >;
...
export type RecurringInvoiceScheduleInsert =
  & Partial<RecurringInvoiceScheduleRow>
  & {
    org_id: string;
    name: string;
    client_id: string;
...
type ProfileInsert =
  & Pick<ProfileRow, "display_name" | "id">
...
type ClientContactInsert =
  ...
  & Partial<
    Omit<ClientContactRow, "client_id" | "contact_id" | "id" | "org_id">
  >;
type TimelineEventInsert =
  & Pick<
    TimelineEventRow,
    "actor_type" | "entity_id" | "entity_type" | "kind" | "org_id" | "title"
  >
  & Partial<
    Omit<
      TimelineEventRow,
...
type ProductInsert =
  ...
  & Partial<
    Omit<ProductRow, "id" | "name" | "org_id" | "sku" | "unit_price_cents">
  >;
type InventoryMovementInsert =
  ...
  & Partial<
    Omit<
      InventoryMovementRow,
      "id" | "org_id" | "product_id" | "quantity_delta" | "reason"
    >
  >;
...
type InvoiceInsert =
  ...
  & Partial<
    Omit<
      InvoiceRow,
      "client_id" | "currency" | "due_on" | "id" | "number" | "org_id"
    >
  >;
...
type BillInsert =
  ...
  & Partial<
    Omit<
      BillRow,
      "currency" | "due_on" | "id" | "number" | "org_id" | "vendor_id"
    >
  >;
type BillLineInsert =
  & Pick<
...
type MeetingInsert =
  ...
  & Partial<
    Omit<
      MeetingRow,
      "id" | "org_id" | "title" | "starts_at" | "ends_at" | "timezone"
    >
  >;
...
type MeetingTranscriptInsert =
  ...
  & Partial<
    Omit<MeetingTranscriptRow, "id" | "org_id" | "meeting_id" | "status">
  >;
type MeetingTaskProposalInsert =
  & Pick<MeetingTaskProposalRow, "org_id" | "meeting_id" | "title">
  & Partial<
    Omit<MeetingTaskProposalRow, "id" | "org_id" | "meeting_id" | "title">
  >;
  ...
  public: {
    Tables: {
      ...
      email_messages: {
        Row: EmailMessageRow;
        Insert:
          & Partial<EmailMessageRow>
          & Pick<EmailMessageRow, "id" | "org_id">;
      ...
      projects: {
        Row: ProjectRow;
        Insert: Partial<ProjectRow> & Pick<ProjectRow, "org_id" | "name">;
