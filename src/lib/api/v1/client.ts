...
import { createProductCategoriesEndpoints } from './endpoints/product-categories.js';
...
import { createNotesEndpoints } from './endpoints/notes.js';
...
export interface ApiV1Client {
	...
	productCategories: ProductCategoriesEndpoints;
...
export function createApiV1Client(options: ApiV1ClientOptions = {}): ApiV1Client {
	...
	return {
		...
		productCategories: createProductCategoriesEndpoints(request),
		...
		notes: createNotesEndpoints(request),
