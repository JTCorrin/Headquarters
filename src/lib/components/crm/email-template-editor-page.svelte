		...
		<div class="space-y-6 px-6 py-6 md:px-8">
			...
			<div class="grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
				...
				>
					...
					<EmailTemplateForm {form} submitLabel="Save template" />
				</section>
				...
				>
					...
					<div class="border-border/80 space-y-3 border-t bg-white p-5 text-black dark:bg-zinc-950 dark:text-zinc-50">
